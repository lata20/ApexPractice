...
export default class Pract extends LightningElement {
    ...
    actionHandler(event){
        ...
        if(label === 'Stop'){
            ...
            //this.show=false;
            this.diff = ((new Date().getTime())/1000/60/60)-((this.timer.getTime())/1000/60/60);
            ...
            action1Handler(){
            const fields = {'StartTime__c' : this.timer, 'EndTime__c' : this.endTime, 'TotalDuration__c': this.diff};
